package prestito_illuminato.auth.configuration;
...
import prestito_illuminato.auth.security.JwtAuthenticationEntryPoint;
import prestito_illuminato.auth.security.JwtAuthenticationFilter;
